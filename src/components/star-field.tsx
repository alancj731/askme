...
interface StarFieldProps {
    blurAmount?: number;
    appearence: 'light' | 'dark' | 'system';
}

export function StarField({ blurAmount = 0, appearence }: StarFieldProps) {
    ...
    useEffect(() => {
        ...
        const drawStars = () => {
            ...
            starsRef.current.forEach((star) => {
                ...
                ctx.fillStyle = appearence === 'dark' ?  `hsla(0, 0%, 100%, ${star.opacity})` : `hsla(120, 60%, 70%, ${star.opacity})`;
                ctx.fill();
            });
